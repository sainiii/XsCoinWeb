<%@ Page Title="" Language="C#" MasterPageFile="~/secaue/MasterPage.Master" AutoEventWireup="true" CodeBehind="upgrade.aspx.cs" Inherits="XsCoinWeb.secaue.upgrade" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="side-app" id="ActivateAccount" data-ng-controller="ActivateAccount as ctrl">
        ...
        <div class="page-header">
            <ol class="breadcrumb">
                <!-- breadcrumb -->
                <li class="breadcrumb-item"><a href="#">Upgrade & Active</a></li>
