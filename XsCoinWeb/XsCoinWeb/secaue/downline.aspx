<%@ Page Title="" Language="C#" MasterPageFile="~/secaue/MasterPage.Master" AutoEventWireup="true" CodeBehind="downline.aspx.cs" Inherits="GlobalBTC.MobileApp.secaue.downline" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <div class="side-app" id="downline" data-ng-controller="downline as ctrl">
        ...
        <div class="card mb-4 fullscreen">
            <div class="card-header">
                <div class="card-title">Downline Team </div>
            </div>
